...
"""
                    ...
                    st.caption(
                        f"Enter price estimates to compare costs for branded **{medName}** vs generic substitutes."
                    )
                    ...
                    with c_cost2:
                        default_generic = round(brand_price * 0.35, 2)
                        generic_price = st.number_input(
                            "Estimated Monthly Cost of Generic Substitute (RM):",
                            min_value=0.0,
                            value=default_generic,
                            step=5.0,
                            key="generic_cost_input",
                        )
                    ...
                    s1.metric("Generic Monthly Cost", f"RM {generic_price:.2f}")
