...
"""
                    ...
                    st.markdown("---")
                    st.subheader("💡 Estimated Generic Cost Savings Calculator")
                    st.caption(
                        f"Estimate savings when choosing a generic substitute over branded **{medName}**."
                    )

                    brand_price = st.slider(
                        f"Estimated Monthly Cost of Branded {medName} ($):",
                        min_value=10,
                        max_value=300,
                        value=80,
                        step=5,
                        key="selected_med_savings_slider",
                    )
                    ...
                    s2.metric("Monthly Savings", f"${monthly_saving:.2f}")
                    s3.metric(
                        "Annual Consumer Savings",
                        f"${annual_saving:.2f}",
                        delta="-65% Cost Reduction",
                    )
